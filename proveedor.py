...
proveedores[1].agregar_producto(productos[5])
proveedores[4].agregar_producto(productos[6])
proveedores[1].agregar_producto(productos[7])
proveedores[0].agregar_producto(productos[8])
proveedores[3].agregar_producto(productos[9])

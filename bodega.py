...
class Bodega:
    ...
    def agregar_producto(self, producto, cantidad): 
        """Agrega un producto a la bodega, especificando la cantidad a ingresar."""
        if cantidad <= 0:
    ...
    def retirar_producto(self, producto, cantidad): 
        """Retira un producto de la bodega, especificando la cantidad a retirar."""
        producto_existente = self.obtener_producto(producto)
    ...
    def mostrar_informacion(self): 
        """Muestra la información de la bodega."""
...
bodegas[0].agregar_producto(productos[5], 14)
bodegas[1].agregar_producto(productos[6], 8)
bodegas[2].agregar_producto(productos[7], 30)
bodegas[3].agregar_producto(productos[8], 23)
bodegas[4].agregar_producto(productos[9], 8)